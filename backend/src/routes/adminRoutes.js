...
router.patch(
  "/sellers/:id/reject",
  validate(sellerRejectionSchema),
  asyncHandler(rejectSeller),
);
router.get("/users", asyncHandler(getUsers));
router.patch(
  "/users/:id/toggle-status",
  validate(userStatusToggleSchema),
...
router.get("/commissions", asyncHandler(getAdminCommissions));
router.patch("/commissions/:id/pay", asyncHandler(payCommission));
router.get("/analytics", asyncHandler(getAdminAnalytics));
router.get("/payments", asyncHandler(getSellerPayments));
router.post("/payments", asyncHandler(createSellerPayment));
...
router.patch(
  "/erp/tickets/:id/resolve",
  validate(adminTicketUpdateSchema),
  asyncHandler(resolveTicket),
);
