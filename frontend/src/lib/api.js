...
export const api = {
  auth: {
    ...
    adminLogin: (payload) =>
      apiClient.post("/auth/admin/login", payload).then(unwrap),
  ...
  seller: {
    ...
    inventory: () =>
      apiClient.get("/seller/erp/inventory?limit=100").then(unwrap),
    ...
    customerDetail: (id) =>
      apiClient.get(`/seller/crm/customers/${id}`).then(unwrap),
    revenueTrend: () =>
      apiClient.get("/seller/analytics/revenue-trend").then(unwrap),
    categorySales: () =>
      apiClient.get("/seller/analytics/category-sales").then(unwrap),
    topProducts: () =>
      apiClient.get("/seller/analytics/top-products").then(unwrap),
  ...
  products: {
    ...
    mine: (params = {}) =>
      apiClient.get("/products/mine", { params }).then(unwrap),
  ...
  cart: {
    ...
    remove: (productId) =>
      apiClient.delete(`/cart/remove/${productId}`).then(unwrap),
  ...
  orders: {
    ...
    verifyPayment: (payload) =>
      apiClient.post("/orders/verify-payment", payload).then(unwrap),
    create: (payload) => apiClient.post("/orders", payload).then(unwrap),
    myPurchases: (params = {}) =>
      apiClient.get("/orders/my-purchases", { params }).then(unwrap),
    mySales: (params = {}) =>
      apiClient.get("/orders/my-sales", { params }).then(unwrap),
    get: (id) => apiClient.get(`/orders/${id}`).then(unwrap),
    updateStatus: (id, payload) =>
      apiClient.patch(`/orders/${id}/status`, payload).then(unwrap),
    cancel: (id) => apiClient.patch(`/orders/${id}/cancel`).then(unwrap),
  },
  bookings: {
    create: (payload) => apiClient.post("/bookings", payload).then(unwrap),
    mine: (params = {}) =>
      apiClient.get("/bookings/my-bookings", { params }).then(unwrap),
    sellerMine: (params = {}) =>
      apiClient.get("/bookings/my-service-bookings", { params }).then(unwrap),
    createPaymentSession: (id, payload = {}) =>
      apiClient.post(`/bookings/${id}/payment-session`, payload).then(unwrap),
    verifyPayment: (id, payload) =>
      apiClient.post(`/bookings/${id}/verify-payment`, payload).then(unwrap),
    payUpi: (id, payload) =>
      apiClient.post(`/bookings/${id}/pay-upi`, payload).then(unwrap),
    messages: (id) => apiClient.get(`/bookings/${id}/messages`).then(unwrap),
    sendMessage: (id, payload) =>
      apiClient.post(`/bookings/${id}/messages`, payload).then(unwrap),
    updateStatus: (id, payload) =>
      apiClient.patch(`/bookings/${id}/status`, payload).then(unwrap),
  },
  reviews: {
  ...
  tickets: {
    ...
    mine: (params = {}) =>
      apiClient.get("/tickets/mine", { params }).then(unwrap),
  },
  admin: {
    overview: () => apiClient.get("/admin/dashboard/overview").then(unwrap),
    sellersPending: (params = {}) =>
      apiClient.get("/admin/sellers/pending", { params }).then(unwrap),
    sellerDetail: (id) => apiClient.get(`/admin/sellers/${id}`).then(unwrap),
    approveSeller: (id) =>
      apiClient.patch(`/admin/sellers/${id}/approve`).then(unwrap),
    rejectSeller: (id, payload) =>
      apiClient.patch(`/admin/sellers/${id}/reject`, payload).then(unwrap),
    users: (params = {}) =>
      apiClient.get("/admin/users", { params }).then(unwrap),
    toggleUser: (id, payload) =>
      apiClient.patch(`/admin/users/${id}/toggle-status`, payload).then(unwrap),
    products: (params = {}) =>
      apiClient.get("/admin/products", { params }).then(unwrap),
    approveProduct: (id) =>
      apiClient.patch(`/admin/products/${id}/approve`).then(unwrap),
    removeProduct: (id) =>
      apiClient.patch(`/admin/products/${id}/remove`).then(unwrap),
    services: (params = {}) =>
      apiClient.get("/admin/services", { params }).then(unwrap),
    approveService: (id) =>
      apiClient.patch(`/admin/services/${id}/approve`).then(unwrap),
    removeService: (id) =>
      apiClient.patch(`/admin/services/${id}/remove`).then(unwrap),
    orders: (params = {}) =>
      apiClient.get("/admin/orders", { params }).then(unwrap),
    commissions: (params = {}) =>
      apiClient.get("/admin/commissions", { params }).then(unwrap),
    payCommission: (id, payload) =>
      apiClient.patch(`/admin/commissions/${id}/pay`, payload).then(unwrap),
    erpOverview: () => apiClient.get("/admin/erp/overview").then(unwrap),
    erpRevenueChart: () =>
      apiClient.get("/admin/erp/revenue-chart").then(unwrap),
    erpTickets: (params = {}) =>
      apiClient.get("/admin/erp/tickets", { params }).then(unwrap),
    ...
    revenueTrend: () =>
      apiClient.get("/admin/analytics/revenue-trend").then(unwrap),
    topSellers: () =>
      apiClient.get("/admin/analytics/top-sellers").then(unwrap),
    topProducts: () =>
      apiClient.get("/admin/analytics/top-products").then(unwrap),
    userGrowth: () =>
      apiClient.get("/admin/analytics/user-growth").then(unwrap),
    analytics: (params = {}) =>
      apiClient.get("/admin/analytics", { params }).then(unwrap),
    sellerPayments: (params = {}) =>
      apiClient.get("/admin/payments", { params }).then(unwrap),
    createSellerPayment: (payload) =>
      apiClient.post("/admin/payments", payload).then(unwrap),
    downloadReport: (params) =>
      apiClient
