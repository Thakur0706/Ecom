...
function ERPDashboard() {
  ...
  const totalRevenue = salesData.monthlySales.reduce(
  ...
  const kpis = [
    {
      title: "Total Users",
      value: erpResources.platformUsage.totalUsers,
      icon: "👥",
      color: "bg-blue-100 text-blue-600",
    },
    {
      title: "Active Listings",
      value: erpResources.listingMetrics.totalActive,
      icon: "📦",
      color: "bg-indigo-100 text-indigo-600",
    },
    {
      title: "Orders Processed",
      value: erpResources.transactionMetrics.totalProcessed,
      icon: "🛒",
    ...
    {
      title: "Success Rate",
      value: `${erpResources.transactionMetrics.successRate}%`,
      icon: "✅",
      color: "bg-teal-100 text-teal-600",
    },
    {
      title: "Pending Approvals",
      value: erpResources.listingMetrics.pendingApproval,
      icon: "⏳",
  ...
  const listingMetrics = [
    ...
    },
    {
      ...
      value: erpResources.listingMetrics.removedThisMonth,
    },
    {
      icon: "🕒",
      label: "Avg Listing Age",
      value: erpResources.listingMetrics.averageListingAge,
    },
  ];
  ...
  const transactionMetrics = [
    ...
    },
    {
      icon: "₹",
      label: "Average Value",
      value: `₹${erpResources.transactionMetrics.averageValue}`,
    },
    {
      icon: "⏰",
      label: "Peak Hour",
      value: erpResources.transactionMetrics.peakHour,
    },
  ];
    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              ERP Dashboard - Enterprise Overview
            </h1>
            <p className="mt-2 text-sm text-slate-500">
              CampusConnect Resource & Operations Planning
            </p>
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-2">
        <div className="space-y-6">
          ...
          {/* Removed Resource Utilization Section */}
        </div>
        ...
        <div className="space-y-6">
          <section className="rounded-2xl bg-white p-6 shadow-md">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link
                to="/reports"
                className="text-sm font-semibold text-blue-600 transition hover:text-indigo-600"
              >
                View All Activity
              </Link>
            </div>
          ...
          <div className="mt-6 space-y-4">
            {transactionMetrics.map((metric) => (
              ...
              >
                ...
                <p
                  className={`text-lg font-bold ${metric.label === "Success Rate" ? "text-emerald-600" : "text-gray-900"}`}
                >
                  {metric.value}
                </p>
              </div>
          ...
          <div className="mt-6 space-y-4">
            {salesData.topProducts.map((product, index) => (
              ...
              >
                ...
                <span
                  className={`text-lg font-bold ${product.trend === "up" ? "text-emerald-600" : "text-rose-600"}`}
                >
                  {product.trend === "up" ? "↑" : "↓"}
                </span>
              </div>
